...
static char buffer_message[MQTT_DATA_LENGTH_MAX];
/***********************************************************************************************************************
* Typedef definitions
***********************************************************************************************************************/
...
static esp_err_t mqtt_event_handler_cb(esp_mqtt_event_handle_t event)
{
    ...
    switch (event->event_id) {
        case MQTT_EVENT_CONNECTED:
            ...
            device_data.mqtt_status = E_MQTT_CONNECTED;
            break;
        case MQTT_EVENT_DISCONNECTED:
            ESP_LOGI(TAG, "MQTT_EVENT_DISCONNECTED");
            device_data.mqtt_status = E_MQTT_DISCONNECT;
            break;
        ...
        case MQTT_EVENT_DATA:
            ...
            memset( buffer_message, 0x00, MQTT_DATA_LENGTH_MAX);
            sprintf(buffer_message, "%s", event->data);
            buffer_message[event->data_len + 1] = 0x00;
            // ESP_LOGI(TAG, "json_parser_message mqtt call");
